...
public class AdbOperatorTests
{
    ...
    [Fact]
    public void Instance_ImplementsIDeviceOperator()
    {
        var operator_ = AdbOperator.Instance;
        Assert.IsAssignableFrom<lenovo.mbg.service.framework.services.Device.IDeviceOperator>(operator_);
    }
}
