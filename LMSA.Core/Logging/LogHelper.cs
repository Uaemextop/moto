...
public class LogHelper
{
    ...
    private void WriteToConsole(string level, string method, string message, Exception exception = null)
    {
        string logLine = $"{DateTime.Now:yyyy-MM-dd HH:mm:ss} [{level}] {method} - {message}";
