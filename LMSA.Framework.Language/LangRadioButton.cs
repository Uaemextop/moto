...
{
	public static readonly DependencyProperty LangKeyProperty = DependencyProperty.RegisterAttached("LangKey", typeof(string), typeof(LangRadioButton), new PropertyMetadata(string.Empty, new PropertyChangedCallback(OnLangKeyChanged)));
