...
{
	public static readonly DependencyProperty ToolTipProperty = DependencyProperty.RegisterAttached("ToolTip", typeof(string), typeof(LangToolTip), new PropertyMetadata(string.Empty, new PropertyChangedCallback(OnToolTipChanged)));
	...
	private static void OnToolTipChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
	{
		...
		{
			((FrameworkElement)((obj is FrameworkElement) ? obj : null)).ToolTip = LangTranslation.Translate(args.NewValue.ToString());
		}
	}
}
