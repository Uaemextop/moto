...
public class LangTextBlock : TextBlock
{
	...
	public static readonly DependencyProperty LangKeyProperty = DependencyProperty.RegisterAttached("LangKey", typeof(string), typeof(LangTextBlock), new PropertyMetadata(string.Empty, new PropertyChangedCallback(OnLangKeyChanged)));
