...
public class LangLabel : Label
{
	...
	public static readonly DependencyProperty LangKeyProperty = DependencyProperty.RegisterAttached("LangKey", typeof(string), typeof(LangLabel), new PropertyMetadata(string.Empty, new PropertyChangedCallback(OnLangKeyChanged)));
