...
public class LangButton : Button
{
	...
	public static readonly DependencyProperty LangKeyProperty = DependencyProperty.RegisterAttached("LangKey", typeof(string), typeof(LangButton), new PropertyMetadata(string.Empty, new PropertyChangedCallback(OnLangKeyChanged)));
