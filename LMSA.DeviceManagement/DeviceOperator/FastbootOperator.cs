...
public class FastbootOperator : IDeviceOperator
{
    ...
    private static FastbootOperator _instance;

    public static FastbootOperator Instance
    {
        get
        {
            if (_instance != null)
            ...
            return _instance = new FastbootOperator();
        }
    }
    ...
    {
        Command($"reboot {mode}".Trim(), 20000, deviceID);
    }
