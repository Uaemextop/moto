...
/// <summary>
/// Represents a device connected via fastboot protocol.
/// Automatically loads device properties when physical connection becomes Online.
/// </summary>
public class FastbootDeviceEx : DeviceEx
{
    ...
    protected override void OnPhysicalStatusChanged(DevicePhysicalStateEx prev, DevicePhysicalStateEx current)
    {
        ...
        }).ContinueWith(delegate
        {
            ...
            {
                LogHelper.LogInstance.Info("Device softStatus Changed ModelName:" + Property?.ModelName + ", IMEI1:" + Property?.IMEI1);
